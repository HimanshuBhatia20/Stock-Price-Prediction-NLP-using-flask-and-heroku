...
def predict():
    ...
    if predictions[0][1]>close_price:
        return render_template('index.html',output='Given Open price = ${} , Close Price = ${}<br>Predictions : Predicted Close Price : ${} ,   PRICE UP '.format(open_price,close_price,round(predictions[0][1],4)))
    else:
        return render_template('index.html',output='Given Open price = ${} , Close Price = ${}<br>Predictions : Predicted Close Price : ${} ,   PRICE DOWN '.format(open_price,close_price,round(predictions[0][1],4)))
