    ...
    if request.method == 'POST':
        ...
        if len(values)==3:
            ...
            if predictions[0][1]>close_price:
                return render_template('index.html',output='<br>GIVEN <br> Open price = $ {}  &emsp;  Close Price = $ {}<br><br>NEWS ENTERED<br> {}<br><br>PREDICTIONS<br> Polarity of News : {}  &emsp; News Sentiment :  {} &emsp; Predicted Close Price : $ {}  &emsp;   PRICE UP : 1 '.format(open_price,close_price,news,sentiment[0],sentiment_text,final_close))
            else:
                return render_template('index.html',output='<br>GIVEN <br> Open price = $ {}  &emsp;  Close Price = $ {}<br><br>NEWS ENTERED<br> {}<br><br>PREDICTIONS<br> Polarity of News : {}  &emsp; News Sentiment :  {} &emsp;  Predicted Close Price : $ {}  &emsp;   PRICE DOWN : 0'.format(open_price,close_price,news,sentiment[0],sentiment_text,final_close))
        else:
            return render_template('index.html',output='INSUFFICIENT DATA : Please Enter details in all 3 fields above')
